...
import works.hop.scrum.domain.Organizer;
...
import works.hop.scrum.config.RepoConfig;
import works.hop.scrum.repo.*;
...
public class ScrumWebApp {
    ...
    public static void main(String[] args) {
        ...
        app.put("/{scrumId}/exit/{name}", "application/json", "application/json", (req, res, done) -> {
            ...
            PlayerExit exitEntity = PlayerExit.builder().name(player).scrumId(scrumId).build();
